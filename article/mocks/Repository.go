...
import article "github.com/bxcodec/go-clean-arch/article"
...
// WithTransaction provides a mock function with given fields: _a0
func (_m *Repository) WithTransaction(_a0 func(article.Repository) error) error {
	ret := _m.Called(_a0)

	var r0 error
	if rf, ok := ret.Get(0).(func(func(article.Repository) error) error); ok {
		r0 = rf(_a0)
	} else {
		r0 = ret.Error(0)
	}
